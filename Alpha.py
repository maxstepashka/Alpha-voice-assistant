    ...
    if wakeword in com_1:
        ...
        if wakeword in com.lower():
            ...
            if "очист" in com.lower() and "корзин" in com.lower():
                ...
                endword = 0
                speak("Как голосовой ассистент, я умею: открывать определённые сайты, искать информацию, управлять браузером, менять раскладку клавиатуры, вводить сказанный вами текст и многое другое.")
