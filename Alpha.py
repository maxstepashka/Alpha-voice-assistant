...
if config["ton_obsh"] != "стандартный" and config["ton_obsh"] != "дерзкий" and config["ton_obsh"] != "вежливый" and config["ton_obsh"] != "вежливый2":
    ...
    if wakeword in com_1:
        ...
        if wakeword in com.lower():
            ...
            if "очист" in com.lower() and "корзин" in com.lower():
                ...
                endword = 0
                speak("Как голосовой ассистент, я умею: открывать определённые сайты, искать информацию в браузере, управлять яркостью монитора, менять раскладку клавиатуры, вводить сказанный вами текст и многое другое.")
