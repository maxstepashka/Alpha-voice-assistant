...
class MainWindow(customtkinter.CTk):
    def __init__(self):
        ...
        self.button_start = customtkinter.CTkButton(master=self.frame_buttons, text='Запустить', width = 240, fg_color=color_main, hover_color=color_hover, font=('TkHeadingFont', 15), corner_radius=5, command=self.start)
        self.button_start.pack(padx=(5, 0), pady=5, side='left')
        self.button_command = customtkinter.CTkButton(master=self.frame_buttons, text='Редактор команд', width = 240, fg_color=color_main, hover_color=color_hover, font=('TkHeadingFont', 15), corner_radius=5, command=self.command)
        self.button_command.pack(padx=(0, 5), pady=5, side='right')




        self.frame_buttons.pack(padx=15, pady=(0, 15))
        ...
        self.label_wakeword = customtkinter.CTkLabel(self.frame_wakeword, width=240, fg_color=color_label, corner_radius=5, text='Активационная фраза', font=('TkHeadingFont', 14))
        self.label_wakeword.pack(padx=5, pady=5, side='left')

        self.wakeword_entry = customtkinter.CTkComboBox(self.frame_wakeword, width = 270, values=[config['wakeword']], border_color=color_main, button_color=color_main, button_hover_color=color_hover, corner_radius=5, font=('TkHeadingFont', 14))
        ...
        self.label_time = customtkinter.CTkLabel(self.frame_time, width=240, fg_color=color_label, corner_radius=5, text='Прием команд без акт. фразы, с', font=('TkHeadingFont', 14))
        self.label_time.pack(padx=5, pady=5, side='left')
        
        self.time_entry = customtkinter.CTkComboBox(self.frame_time, width = 270, values=[str(config['time'])], border_color=color_main, button_color=color_main, button_hover_color=color_hover, corner_radius=5, font=('TkHeadingFont', 14))
        ...
        self.label_recognition = customtkinter.CTkLabel(self.frame_recognition, width=240, fg_color=color_label, corner_radius=5, text='Вариант распознавания', font=('TkHeadingFont', 14))
        self.label_recognition.pack(padx=5, pady=5, side='left')

        self.recognition_entry = customtkinter.CTkOptionMenu(self.frame_recognition, width = 270, values=['Vosk', 'Google Speech Recognition'], fg_color=color_main, button_color=color_main, button_hover_color=color_hover, corner_radius=5, font=('TkHeadingFont', 14))
        ...
        self.label_model = customtkinter.CTkLabel(self.frame_model, width=240, fg_color=color_label, corner_radius=5, text='Версия модели Vosk', font=('TkHeadingFont', 14))
        self.label_model.pack(padx=5, pady=5, side='left')

        self.model_entry = customtkinter.CTkOptionMenu(self.frame_model, width = 270, values=['0.22', '0.4'], fg_color=color_main, button_color=color_main, button_hover_color=color_hover, corner_radius=5, font=('TkHeadingFont', 14))
        ...
        self.label_theme = customtkinter.CTkLabel(self.frame_theme, width=240, fg_color=color_label, corner_radius=5, text='Тема приложения', font=('TkHeadingFont', 14))
        self.label_theme.pack(padx=5, pady=5, side='left')

        self.theme_entry = customtkinter.CTkOptionMenu(self.frame_theme, width = 270, values=['Светлая', 'Тёмная'], fg_color=color_main, button_color=color_main, button_hover_color=color_hover, corner_radius=5, font=('TkHeadingFont', 14))
        ...
        self.label_color = customtkinter.CTkLabel(self.frame_color, width=240, fg_color=color_label, corner_radius=5, text='Акцентный цвет', font=('TkHeadingFont', 14))
        self.label_color.pack(padx=5, pady=5, side='left')

        self.color_entry = customtkinter.CTkOptionMenu(self.frame_color, width = 270, values=['Оранжевый', 'Зелёный', 'Синий', 'Красный', 'Бирюзовый'], fg_color=color_main, button_color=color_main, button_hover_color=color_hover, corner_radius=5, font=('TkHeadingFont', 14))
