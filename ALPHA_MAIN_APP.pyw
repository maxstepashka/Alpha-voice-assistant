...
wakeword_entry = customtkinter.CTkComboBox(master=app, values=[config["wakeword"]], border_color="#FF7F26", button_color="#FF7F26", button_hover_color="#DF5900")
...
voice_entry = customtkinter.CTkComboBox(master=app, values=["xenia", "kseniya", "baya"], border_color="#FF7F26", button_color="#FF7F26", button_hover_color="#DF5900")
...
ton_obsh_entry = customtkinter.CTkComboBox(master=app, values=["стандартный", "вежливый", "дерзкий"], border_color="#FF7F26", button_color="#FF7F26", button_hover_color="#DF5900")
