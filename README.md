...
1) Установите Python 3.11.4 (или выше) проставив все галочки на первой странице установщика. Модель распознавания речи Vosk поместите в папку с файлами ассистента, предварительно распаковав её (модель). Модель должна называться  "vosk-model-small-ru-0.4".
