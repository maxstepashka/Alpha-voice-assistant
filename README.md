...
# Установка
Если вы хотите установить "Альфу" на свой компьютер, лучше дождитесь готового установщика (Модель Vosk устанавливать будет не нужно, от вас лишь потребуеться установить Python 3.11.4, всё остальное установиться автоматически.)
Как запустить исходный код рассказано в файле "requirements.txt".
Библиотеки загружаються автоматически при первом запуске.
