...
18) Открыть файл записи действий (Ключевая фраза: файл записи действий/файл логирования)
19) Завершение работы ассистента (Ключевая фраза: заверши работу)
*Ключевая фраза - если запрос содержит ключевую фразу команды, она будет исполнена.
