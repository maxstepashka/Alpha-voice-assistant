...
Запустите приложение и нажмите на вкладку "Справка" на боковой панели для получения инструкции по запуску.

**Важно**: первый запуск приложения производится дольше последующих. Это связяно с распаковкой компонентов.
