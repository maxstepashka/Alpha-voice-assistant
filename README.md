...
3) В соответствующие поля введите ключевую фразу, по которой будет открываться сайт или приложение, а также полную ссылку/название ярлыка или файла приложения (См. пункт. 4).
